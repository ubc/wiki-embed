		...
		<form method="post" action="admin.php?page=wikiembed_settings_page">
			...
			<table class="form-table">
				<tr>
					...
					<td class="field">
						...
						<input type="checkbox" aria-required="true" value="1" name="wikiembed_options[accordions]" id="wiki-embed-edit" <?php checked( $wikiembed_options['accordions'] ); ?> /> <span ><label for="wiki-embed-edit">Ability to convert a Wiki page headlines into accordion </label></span>    <br />
			...
			<table class="form-table">
				...
				<tr><!-- Internal wiki links -->
					<th valign="top" class="label" scope="row">
						<span class="alignleft"><label for="src">Internal wiki links</label></span>
						<br />
						<div class="help-div">Internal wiki links are links that take you to a different page on the same wiki.</div>
					</th>
					<td class="field">
						<label>
							<input name="wikiembed_options[wiki-links]" type="radio" value="default"  <?php checked($wikiembed_options['wiki-links'],"default"); ?> /> Default &mdash; links takes you back to the wiki
						</label>  <br />
						<label>
							<input name="wikiembed_options[wiki-links]" type="radio" value="overlay" <?php checked($wikiembed_options['wiki-links'],"overlay"); ?> /> Overlay &mdash; links open with the content in an overlay window
						</label> <br />
						<label>
							<input name="wikiembed_options[wiki-links]" type="radio" value="new-page" <?php checked($wikiembed_options['wiki-links'],"new-page"); ?>  /> WordPress Page &mdash; links open a WordPress page with the content of the wiki
						</label>  <br />
					...
					<td>
						...
						<div id="display-wiki-source" >
							<div style="float:left; width:80px;">
								Before the link
								<br />
								<input type="text" name="wikiembed_options[default][pre-source]" size="7" value="<?php echo esc_attr($wikiembed_options['default']['pre-source']); ?>" />
								<br />
							</div>
			...
			<table class="form-table">
				<tr>
					...
					<td class="field">
						...
						<span>
							<label for="wiki-embed-tabs">Convert section headings to tabs</label>
						</span>
						<br />
						...
						<span>
							<label for="wiki-embed-accordion">Convert section headings to accordion</label>
						</span>
						<br />
						...
						<span>
							<label for="wiki-embed-normal-headers">Don't convert section headings</label>
						</span>
						<br />
						
						<input type="checkbox" aria-required="true" value="1" name="wikiembed_options[default][no-edit]" id="wiki-remove-edit" <?php checked( $wikiembed_options['default']['no-edit'] ); ?> />
						<span>
							<label for="wiki-remove-edit">Remove edit links</label>
						</span>
						<br />
						
						<div class="help-div">Often wiki pages have edit links displayed next to sections, which is not always desired. </div>
						<input type="checkbox" aria-required="true" value="1" name="wikiembed_options[default][no-contents]" id="wiki-embed-contents" <?php checked( $wikiembed_options['default']['no-contents'] ); ?> />
						<span>
							<label for="wiki-embed-contents">Remove table of contents</label>
						</span>
						<br />
						
						<div class="help-div">Often wiki pages have a table of contents (a list of content) at the top of each page. </div>
						<input type="checkbox" aria-required="true" value="1" name="wikiembed_options[default][no-infobox]" id="wiki-embed-infobox" <?php checked( $wikiembed_options['default']['no-infobox'] ); ?> />
						<span>
							<label for="wiki-embed-infobox">Remove infoboxes</label>
						</span>
						<br />
...
function wikiembed_options_validate( $wikiembed_options ) {
	return array(
		...
		'default' => array(
			...
			'no-infobox'  => ( isset( $wikiembed_options['default']['no-infobox']  ) && $wikiembed_options['default']['no-infobox']  == 1 ? 1 : 0 ),
			'no-edit'     => ( isset( $wikiembed_options['default']['no-edit']     ) && $wikiembed_options['default']['no-edit']     == 1 ? 1 : 0 ),
